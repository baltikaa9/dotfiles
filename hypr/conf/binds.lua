...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("~/.config/bin/brightnessctl-all.sh set +10%"), { locked = true, repeating = true })
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("~/.config/bin/brightnessctl-all.sh set 10%-"), { locked = true, repeating = true })
...
-- Waybar
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd('pkill waybar; pkill cava; hyprctl dispatch exec waybar'))

-- Other
hl.bind('Print', hl.dsp.exec_cmd('GRIMBLAST_EDITOR="satty --filename" SLURP_ARGS="-w 0" grimblast edit area'))
hl.bind('SHIFT + Print', hl.dsp.exec_cmd('GRIMBLAST_EDITOR="satty --filename" SLURP_ARGS="-w 0" grimblast --freeze edit area'))
